...
\begin{itemize}
    \item 正解:\quad $BCD$
    \item 总结:\quad $C$选项比较难做,需要求解出在刚好发生相对滑动的时候整体向上的加速度为$g$,而在刚接触弹簧的时候加速向下也为$g$.
...
\begin{center}
    ...
    \includegraphics[width=0.55\textwidth,keepaspectratio]{./pictures/3.6-2.png}
...
\includegraphics[width=0.85\textwidth,keepaspectratio]{./pictures/3.8-1.png}
...
\includegraphics[width=0.85\textwidth,keepaspectratio]{./pictures/3.8-2.png}
...
\begin{itemize}
    ...
    \end{enumerate}
    \item 总结:特殊的是第二问,两个金属球碰撞后需要均分电荷
