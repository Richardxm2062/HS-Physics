                  ...
                  \begin{enumerate}[label=(\arabic*)]
                      ...
                      \item []
                            ...
                            \begin{align*}
                                ...
                                x_{i} = i \triangle x \hspace{0.5em}(i = 1,2,3 \dots \infty)                                                                                                           \\
                                \triangle W_{i} & = F_{i} \triangle x = k x_{i} \triangle x  \hspace{2em} \sum_{i=1}^{n}\triangle W_{i} =
                                k(x_{1}+x_{2}+x_{3} \dots x_{n} )\triangle x                                                                                                                           \\
                                W               & = k \triangle x (\triangle x + 2 \triangle x +3 \triangle x \dots + n \triangle x) = k \triangle x \qty{ \dfrac{(\triangle x + n \triangle x)n}{2} } \\
