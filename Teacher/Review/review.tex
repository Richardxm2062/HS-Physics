...
\subsection{放射性元素的衰变}
\begin{enumerate}
    \item 原子核的表示: $_{Z}^{A}X$ \quad ($A$表质量数,$Z$为原子核的电荷数 \, eg. $_{2}^{4}He$)
    ...
    \item 衰变形式:
          \begin{itemize}
              ...
              \item $\beta$衰变：放射性元素原子核的中子转变为质子与电子(\textbf{非核外电子})
                    ...
                    $$
              \item $\gamma$衰变: $\alpha$衰变与$\beta$衰变过程中通常会伴随着$\gamma$射线
                    $$
                        \begin{aligned}
                        ...
                        \end{aligned}
                    $$
              \item 三种衰变的区别: $\alpha \, \beta $衰变改变的原子核结构,$\gamma$衰变仅释放能量(并没有释放$\nuc{1}{0}{n}$)
              \item 衰变的轨迹分析: eg.$\alpha$衰变处在$X$磁场下
                    \begin{align*}
