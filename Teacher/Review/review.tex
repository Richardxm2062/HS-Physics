...
\begin{itemize}
    \item 光速(传播): 真空中传播速度$c = 3 \cross 10^{8}m/s $
...
\begin{minipage}{0.62\textwidth}
    \begin{itemize}
        ...
        \item 最大初动能: 一定频率光照下刚逃逸的电子所具有
              ...
              \hspace{5.5em}最大初动能 $E_{kmax} = h\nu - W_{0}$
        \item[]
        \item 截止频率(极限频率): 恰好发生光电效应时的频率

              \hspace{9.6em}$E_{kmax} = 0 \lra \nu_{\text{极限}} = \frac{W_{0}}{h} $
        \item[]
        ...
        \item 遏止电压: 恰好使得没有任何电子打到极板
              ...
              \hspace{4.6em}$V_{\text{遏止}} \vdot e = E_{kmax}$ (抵消电子最大初动能)
    \end{itemize}
\end{minipage}
