          ...
          \begin{enumerate}[label = (\arabic*)]
              ...
              \item 毛细现象: 本质上是 \, \textbf{浸润} \,和\, \textbf{表面张力} \, 的共同作用
                    ...
                    \hspace{4.7em}\begin{minipage}{0.7\textwidth}
                        ...
                        长时间下雨\textbf{踩土}(减少土壤缝隙宽度)\textbf{加强}毛细现象,减少树木根部积水

                        干旱后下雨\textbf{刨土}(使得土壤不再有缝隙)\textbf{破坏}毛细现象,增加树木根部水量
                    \end{minipage}
          \end{enumerate}
...
\begin{enumerate}[label = \arabic*]
    ...
    \item 永动机
          ...
          \begin{enumerate}[label = (\arabic*)]
              \item 第一类永动机[内部能量完美相互转换](无法造出来): 违背能量守恒,会有其他能量损耗
...
\begin{minipage}{0.5\textwidth}
    \begin{itemize}
        \item 核外表层电子吸收能量克服阻碍\textbf{逃离(电离)}
        \item[]
...
\begin{enumerate}[label = (\arabic*)]
    ...
    \item \textbf{从比结合能角度理解稳定性}
          ...
          说明核子结合更牢,原子核更稳定,比结合能增大

    \item \textbf{统一理解}

          核反应的本质: \textbf{反应方向由原子核稳定性决定,通常向着比结合能增大的方向发生}

          \hspace{6.7em}但是否发生还取决于具体条件

          \hspace{6.7em}$\text{比结合能增大} \Longleftrightarrow \text{总结合能增大} \Longleftrightarrow \text{放能} \Longleftrightarrow \text{质量亏损} $
\end{enumerate}
