...
\begin{itemize}
    ...
    \item 充放气问题-物质的量的变化
          \begin{enumerate}
              ...
              \item 充气: 待充气体的压强$P$通常会给出,容器体积不变
                    $$
                        P_{0}V_{0} + n P\triangle{V} = P_{n}V_{0}
                    $$
              \item 抽气: 两种抽气模型(不能混用,$\triangle{V}$的物理含义不一样)
                    \begin{itemize}

                        \item 固定抽气体积($\triangle{V}$),视为等温扩容
                              $$
                                  P_{0}V_{0} = P_{1}(V_{0}+\triangle {V}) \lra P_{n+1} = \frac{V_{0}}{V_{0} + \triangle{V}} P_{n}
                              $$
                              $$
                                  P_{n} = (\frac{V_{0}}{V_{0} + \triangle{V}})^{n} P_{0}
                              $$
                        \item 按比例抽气($\triangle{V} = k V$),剩余气体重新充满原体积
                              $$
                                  P_{1}V_{1} - P_{1}\triangle V = P_{2}V_{1} \lra  P_nV - P_n\triangle V = P_{n+1}V  \lra P_{n+1} = P_n (1-\frac{\triangle V}{V})
                              $$
                              $$
                                  P_n = P_0 \left(1-\frac{\triangle V}{V}\right)^n = P_0 \left(1-k\right)^n
                              $$
                    \end{itemize}
          \end{enumerate}
    \item 气体密度: $\frac{P}{T}$不变时,密度不变;$\frac{m_{1}}{m_{2}} = \frac{V_{1}}{V_{2}}$
    \item []\vspace{-1em}
          \hspace{-0.9em}
          \begin{adjustbox}{minipage=0.59\linewidth, bgcolor=gray!20, padding=1em}
              \small
              $\rho = \frac{M}{V} = \frac{n M_{mol}}{V} = \frac{M_{mol} P}{RT}$(同一种气体摩尔质量 $M_{mol}$ 不变)
              \quad $\rho \propto \frac{P}{T}$
          \end{adjustbox}
          \vspace{-1em}
\end{itemize}
