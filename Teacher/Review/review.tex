    ...
    \item 油膜法测量分子的直径
          ...
          \begin{enumerate}[label = (\arabic*{})]
              ...
              \item[] 物理量之间的关系(从实际的物理含义去理解记忆):
                    ...
                    \begin{enumerate}
                        \item 微观-化学 \quad $ m_{0} \vdot N_{A} = M_{mol} \quad V_{0} \vdot N_{A} = V_{mol}$

                        \item 微观-宏观 \quad $m_{0} \vdot N = M \hspace{2.5em} V_{0} \vdot N = V $


                        \item 化学-宏观 \quad $n = \frac{N}{N_{A}} \hspace{4.5em} M_{mol} = \frac{M}{n} \hspace{2.5em} V_{mol} = \frac{V}{n}$
                    \end{enumerate}
                    $$
