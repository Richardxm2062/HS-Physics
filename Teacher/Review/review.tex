...
\begin{enumerate}
    ...
    \item 结合能
          ...
          把原子核中的核子完全分开所需要的能量称为结合能

          一般来说,核子数越多,总结合能越大,因此更有意义的是比较其平均值

          原子核的质量\textbf{小于}组成它的核子质量之和,
          其差值对应的能量即为\textbf{结合能}
...
\begin{enumerate}[label = (\arabic*)]
    ...
    \item \textbf{从比结合能角度理解稳定性}
          ...
          重核(铀) $\rightarrow$ 中等质量核(钡、氪)

          比结合能增大,说明核子结合更牢,原子核更稳定

    \item \textbf{统一理解}

          核反应的本质可以概括为:核反应通常朝着比结合能更大的方向进行

          \hspace{11.6em}但是否发生还取决于具体条件
          $$
              \text{比结合能增大}
              \Longleftrightarrow
              \text{总结合能增大}
